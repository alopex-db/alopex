...
- [ ] Create and push only the annotated Rust tag at the recorded main SHA; the Core workflow creates the matching Python tag after Core publication succeeds.
