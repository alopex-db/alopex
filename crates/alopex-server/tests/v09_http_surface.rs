...
const API_ROUTES: [ApiRoute; 61] = [
    ...
    ApiRoute {
        label: "POST /crdt/sets",
        path: "/crdt/sets",
        method: RouteMethod::Post,
        request_schema: "SetCreateRequest",
        response_schema: "CrdtOutcome",
        streaming: StreamBehavior::None,
    },
    ApiRoute {
        label: "POST /crdt/counters/{object_id}/read",
        path: "/crdt/counters/{object_id}/read",
        method: RouteMethod::Post,
        request_schema: "CounterReadRequest",
        response_schema: "CrdtOutcome",
        streaming: StreamBehavior::None,
    },
    ApiRoute {
        label: "POST /crdt/sets/{object_id}/read",
        path: "/crdt/sets/{object_id}/read",
        method: RouteMethod::Post,
        request_schema: "SetReadRequest",
        response_schema: "CrdtOutcome",
        streaming: StreamBehavior::None,
    },
    ApiRoute {
        label: "POST /crdt/sets/{object_id}/add",
        path: "/crdt/sets/{object_id}/add",
        method: RouteMethod::Post,
        request_schema: "SetAddRequest",
        response_schema: "CrdtOutcome",
        streaming: StreamBehavior::None,
    },
    ApiRoute {
        label: "POST /crdt/counters/{object_id}/increment",
    ...
    ApiRoute {
        ...
        method: RouteMethod::Post,
        request_schema: "KvTxnRequest",
        response_schema: "KvStatusResponse",
        streaming: StreamBehavior::None,
    },
    ApiRoute {
...
const I13_REGISTER: [&str; 64] = [
    "POST /crdt/counters",
    "POST /crdt/sets",
    "POST /crdt/counters/{object_id}/read",
    "POST /crdt/sets/{object_id}/read",
    "POST /crdt/sets/{object_id}/add",
