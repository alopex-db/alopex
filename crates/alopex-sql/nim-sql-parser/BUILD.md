...
The current SQL/PromQL MessagePack contract version is `0.8.0`.
...
file and that its contract-0.8.0 and checksum sidecars are self-consistent; a
...
libraries and the manifest with verified contract-0.8.0 assets, retargets the
