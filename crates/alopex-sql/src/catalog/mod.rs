...
pub use table::{
    ColumnMetadata, Compression, RELATIONAL_CONSTRAINTS_PROPERTY, RowIdMode, StorageOptions,
    StorageType, TableMetadata, VIEW_DEFINITION_PROPERTY, VIEW_DEPENDENCIES_PROPERTY,
};
