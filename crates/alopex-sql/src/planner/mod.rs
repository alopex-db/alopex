...
fn classify_generic_host_statement(statement_kind: &StatementKind) -> GenericHostStatement<'_> {
    ...
    match statement_kind {
        ...
        StatementKind::ShowTables => GenericHostStatement::ShowTables,
        StatementKind::ShowIndexes => GenericHostStatement::ShowIndexes,
        StatementKind::Describe { table } => GenericHostStatement::Describe { table },
