...
fn main() {
    ...
    // The Python extension keeps its own native asset directory for the
    // optional Python-facing parser library. Rust consumers link the parser
    // statically through alopex-sql and do not need an inherited rpath.
