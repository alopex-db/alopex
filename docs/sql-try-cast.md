...
| --- | --- | --- | --- | --- |
| Nim source, descriptor, Rust consumer | emit and require contract `0.19.0` | keep synchronized | every wire-schema change | parser, MessagePack, exported-version tests |
...
| four parser archives and manifest | native producer identity | stage fresh contract-0.19.0 Linux x86_64, macOS x86_64/arm64, Windows x86_64 assets | all target records and native smoke pass | release join verifier |
