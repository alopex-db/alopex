...
Measured at: 2026-09-07T12:50:27.086030+00:00
...
|---|---:|---:|---:|---:|---|
| `read_overhead_pct` | 0.7438 % | — | — | 0 | insufficient_history |
| `scan_overhead_ms` | 0.0016 ms | — | — | 0 | insufficient_history |
| `write_overhead_pct` | 1.3685 % | — | — | 0 | insufficient_history |
