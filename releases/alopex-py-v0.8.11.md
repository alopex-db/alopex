...
Measured at: 2026-09-08T04:09:46.362251+00:00
...
|---|---:|---:|---:|---:|---|
| `read_overhead_pct` | 0.2694 % | — | — | 2 | insufficient_history |
| `scan_overhead_ms` | 0.0005 ms | — | — | 2 | insufficient_history |
| `write_overhead_pct` | 0.5460 % | — | — | 2 | insufficient_history |
